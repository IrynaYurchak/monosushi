...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    // Другий Firebase-проєкт (з псевдонімом 'secondary')
    provideFirebaseApp(() =>
      initializeApp(
        {
        ...
        "secondary" // Назва другого Firebase-проєкту
      )
    ),
    provideStorage(() => getStorage(initializeApp({
      projectId: "monosushinew",
      appId: "1:564594953609:web:f610c850f2bbc59074e558",
      storageBucket: "monosushinew.appspot.com",
      apiKey: "AIzaSyC_f92NnsF1l_OemEPyP6A3DWAGNjegeWs",
    ...
    provideFirestore(() => getFirestore(initializeApp({
      projectId: "monosushinew",
      appId: "1:564594953609:web:f610c850f2bbc59074e558",
      storageBucket: "monosushinew.appspot.com",
      apiKey: "AIzaSyC_f92NnsF1l_OemEPyP6A3DWAGNjegeWs",
    ...
    provideAuth(() => getAuth(initializeApp({
      projectId: "monosushinew",
      appId: "1:564594953609:web:f610c850f2bbc59074e558",
      storageBucket: "monosushinew.appspot.com",
      apiKey: "AIzaSyC_f92NnsF1l_OemEPyP6A3DWAGNjegeWs",
